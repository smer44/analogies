...
input_sv_file = "../input/Rus_word_ngramm/v_obj.txt"

input_as_file = "../input/Rus_word_ngramm/v_obj.txt"

output_sv_file = "../output/out_Rus_word_ngramm_tfidf_vo.txt"
output_as_file = "../output/out_Rus_word_ngramm_tfidf_ov.txt"

#exclude personal names
input_folder_exclude  = "..\input\pnames"
